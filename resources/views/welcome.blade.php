    ...
    <source src="{{ asset('carvid2.mp4') }}" type="video/mp4">
            ...
            @if (Route::has('login'))
                ...
                {!! __(' :faqs :about_us  :contact_us' , [
                                      'faqs' => '<a  target="_blank"  href="'.route('faqs').'" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500" style="margin-right: 20px;">'.__('FAQs').'</a>',
